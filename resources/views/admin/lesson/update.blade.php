    ...
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$lesson->lesson_name}}" placeholder="" id="lesson_name" name="adminName">
            </div>
        </div>
        <div class="row cl">
			...
			<select class="select" name="adminRole" size="1">
                ...
                @foreach($course as $v)
                    <option value="{{$v->id}}" @if($lesson->course_id==$v->id) selected @endif>{{$v->course_name}}</option>
                @endforeach
			</select>
			</span> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="text" class="input-text" name="cover_img" id="cover_img"  value="{{$lesson->lesson_img}}"/>
                <div id='a' style="">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="status" type="radio" value="1" id="sex-1" @if($lesson->status==1) checked @endif>
