...
<head>
    ...
    <link rel="stylesheet" href="{{asset('home')}}/css/page-learing-index.css" />
</head>
...
<body data-spy="scroll" data-target="#myNavbar" data-offset="150">
        ...
        <div class="conten-list">
            @foreach($courseData as $v)
                ...
                <div class="row text-center top">
                    ...
                    <div class="col-lg-3 text-right"><a href="{{url('home/course/detail/'.$v->id)}}" class="btn btn-default ck-all">查看全部</a></div>
                </div>
                <div class="container cont-list">
                    <div class="cont-list-roll">
                        ...
                        <div class="cont-list-box">
                            @foreach($v->lession as $vo)
                                <li class="" onclick="detail({{$vo->id}})">
                                    <img src="{{asset('home')}}/img/page-1.jpg" alt="AA">
                                    <div class="tit">{{$vo->lesson_name}} <span>高</span></div>
                                    <div>{{$vo->eacher_name}}</div>
                                    <div>1门课程</div>
                                </li>
                            @endforeach
                        </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <div>
                        <!--<h1 style="display: inline-block">学成网</h1>--><img src="{{asset('home')}}/img/asset-logoIco.png" alt=""></div>
    ...
    <script type="text/javascript" src="{{asset('home')}}/js/widget-travel-index-nav.js"></script>
    <script>
